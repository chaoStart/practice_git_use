...
const App = memo(() => {
  ...
  const [device_yield, setdevice_yield] = useState('日收率');
  ...
  return (
    <>
      <div className="title">
        ...
        <span className="platformTitle">煤制乙二醇测试验证平台</span>
        ...
        <div className="content-right">
          ...
          <div className="safeGeneration">
            ...
            <div className="safeGenerationContent">
              ...
              <div className="picture1">2</div>
              <div className="picture2">7</div>
              <div className="picture3">6</div>
              <div className="picture4">9</div>
