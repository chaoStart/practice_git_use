...
const ProductionStatistics = memo((props) => {
    ...
    const data = {
        'DMO合成': ['4.55万吨', '13425吨', '38.3万立方米', '9.13'],
        'DMO精馏': [],
        'EG合成': [],
        'EG精馏': []
    }
        ...
        <div className='ProductionStatistics_container'>
            ...
            </div>
            {
                props.workSpace === 'DMO精馏' ? null : <div className="content">
                    ...
                    <div className="content-number">60</div>
                </div>
            }
