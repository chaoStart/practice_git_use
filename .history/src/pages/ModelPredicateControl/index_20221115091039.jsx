...
const ModelPredictiveControl = memo(() => {
    ...
    const dataInit = async () => {
        ...
        const startTime = moment().subtract(10, 'minutes').utc().format();
        const endTime = moment().utc().format();
        const params = { startTime, endTime, variable1: 'TICCOL11', variable2: 'LICCOL11', variable3: 'XICCOL11' }
        await API({
            method: 'post',
            headers: {
                'Authorization': 'Bearer aebe97e6-2cbf-4a1f-89b1-277ef3538962',
                'User-Agent': 'apifox/1.0.0 (https://www.apifox.cn)',
                'Content-Type': 'application/json'
            },
            data: JSON.stringify(
