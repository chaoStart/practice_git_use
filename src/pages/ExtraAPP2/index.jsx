        ...
        <div id="mainbox">
            <div className="topApp">
                <div className="appitem">
                    ...
                    <img src={img1} alt="1" onClick={() => { window.open('http://218.94.19.58:8080/#/runtime-fullscreen/runtime-fullscreen/Page_fd165cd381b1487faa451e4dcb5b06aa', "target", ""); }} />
            ...
            <div className="bottomApp">
                ...
                <div className="appitem">
                    {/* <div className="img"></div> */}
                    <img src={img6} alt="1" onClick={() => { window.open('http://218.94.19.58:8080/#/runtime-fullscreen/runtime-fullscreen/Page_7c75252f000f40f59ed48df7ce679243', "target", ""); }} />
                    <div className="apptitle">
                        能源供需平衡
                    </div>
                </div>
                <div className="appitem">
                    {/* <div className="img"></div> */}
                    <img src={img7} alt="1" onClick={() => { window.open('http://218.94.19.58:8080/#/runtime-fullscreen/runtime-fullscreen/Page_6d59c30437564e269f9b75d73ee5b32a', "target", ""); }} />
                    <div className="apptitle">
                        能源分析预测
                    </div>
                </div>
